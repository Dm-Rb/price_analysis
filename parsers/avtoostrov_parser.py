...
class AutoostrovBy:
    ...
    @classmethod
    def __get_html(cls, url: str, method: str = 'get', host=True):
        url = cls.__host + url if host else url
        request = {
        ...
        if search_article_url:
            ...
            if filtered_a_list:
                for a in filtered_a_list:
                    html = cls.__get_html(url=a['href'], host=False)
...
# r = AutoostrovBy.main('441019', "KYB")
# print(r)
